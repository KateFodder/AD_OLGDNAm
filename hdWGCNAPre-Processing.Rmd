...
counts <- readMM("//rdp.arc.ucl.ac.uk/ritd-ag-project-rd01b9-mdcfe39/scRNAseqAD/Filtered/matrix.mtx.gz")

# Step 2: Load gene names
genes <- readLines("//rdp.arc.ucl.ac.uk/ritd-ag-project-rd01b9-mdcfe39/scRNAseqAD/Filtered/features.tsv.gz")

# Step 3: Load barcodes
barcodes <- read.delim("//rdp.arc.ucl.ac.uk/ritd-ag-project-rd01b9-mdcfe39/scRNAseqAD/Filtered/barcodes.tsv.gz", header = TRUE) 
